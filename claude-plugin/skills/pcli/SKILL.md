---
name: pcli
description: Scan repository for CLI commands, build targets, asset converters, game pipelines, and helper scripts (alias for /ptools)
---

# /pcli — Project Toolchain & CLI Catalog
...
4. If arguments are passed (e.g. `/pcli add <name> <cmd>` or `/pcli remove <name>`), manage custom tool registrations.
