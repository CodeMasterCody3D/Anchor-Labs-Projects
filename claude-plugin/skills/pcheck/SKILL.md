---
name: pcheck
description: Audit project supervisor governance invariants (no drift, no unstructured web searches), check historical scan progress, and monitor background subagent tasks
---

# /pcheck — Project Supervisor & Subagent Audit
